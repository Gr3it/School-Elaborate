document
  .querySelector(".pop-up-container")
  .addEventListener("click", function () {
    var element = document.querySelector(".pop-up-container");
    element.classList.remove("pop-up-active");
  });
...
document.querySelector(".avanti1").addEventListener("click", function () {
  if (
    ...
    var element = document.querySelector(".pop-up-container");
    element.classList.add("pop-up-active");
  } else {
